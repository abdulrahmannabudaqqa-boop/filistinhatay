...
const translations = {
  ar: {
    ...
    cityGuide: "دليل إسكندرون للطلاب",
    admin: "لوحة التحكم",
    ...
    // City Guide / İskenderun Rehberi Section
    cityGuideTitle: "دليل مدينة إسكندرون والمعيشة للطالب الأجنبي",
    cityGuideSub: "عناوين ومواقع أهم المقاهي الدراسية، المناطق، مراكز التسوق، المواصلات والخدمات الحكومية في إسكندرون للطلاب الجدد.",
    allPlaces: "جميع المواقع والأماكن",
    catCafes: "المقاهي ومساحات الدراسة",
    catDistricts: "المناطق والكورنيش والمعالم",
    catShopping: "مراكز التسوق والأسواق",
    catTransport: "المواصلات ومحطات السفر",
    catServices: "الدوائر الحكومية والنفوس",
    catHospitals: "المشافي والصحة والطوارئ",
    catFood: "شاورما وأكلات إسكندرون الشهيرة",
    catBazaars: "البازارات والأسواق الأسبوعية",
    operatingDayLabel: "يوم البازار",
    operatingDayPlaceholder: "مثال: يوم الإثنين (Pazartesi)",
    bazaarScheduleTitle: "جدول مواعيد وأيام البازارات الأسبوعية في إسكندرون 🛒",
    bazaarScheduleSub: "دليل الطالب لشراء الخضار، الفواكه الطازجة، المؤن والملابس بأسعار رخيصة ومباشرة من المنتجين في أحياء إسكندرون.",
    bazaarDayPrefix: "يوم",
    bazaarAddressNote: "العنوان وموقع السوق",
    searchCityPlaceholder: "ابحث عن مقهى، منطقة، مركز تسوق، حي، أو ميزة (مثل واي فاي، دراسة)...",
    openInGoogleMaps: "فتح في خرائط جوجل",
    copyAddress: "نسخ العنوان",
    addressCopied: "تم نسخ العنوان إلى الحافظة بنجاح!",
    studentPopular: "مفضل ومناسب للطلاب 🎓",
    studentTipsLabel: "نصائح وإرشادات للطلاب",
    openingHoursLabel: "ساعات العمل",
    districtLabel: "المنطقة / الحي",
    noPlacesFound: "لم يتم العثور على أماكن مطابقة لبحثك.",
    placesCount: "مكان وموقع مدرج",
    quickStudentGuideModalTitle: "الدليل الإرشادي المتكامل للمعيشة والمواصلات في إسكندرون",
    readStudentGuide: "دليل الطالب الشامل للتنقل والحياة بإسكندرون 📖",
    sharePlace: "مشاركة الموقع",
    featuresLabel: "المزايا المتوفرة",
    featWifi: "واي فاي سريع",
    featStudy: "جلسات هادئة للدراسة",
    featBudget: "أسعار اقتصادية للطلاب",
    featSeaView: "إطلالة بحرية",
    featOpenLate: "يفتح لساعات متأخرة",
    featBusStop: "موقف باص قريب",
    featCampus: "داخل حرم الجامعة",
    tabCityPlaces: "إدارة دليل إسكندرون",
  ...
  tr: {
    ...
    cityGuide: "İskenderun Şehir Rehberi",
    ...
    // City Guide / İskenderun Rehberi Section
    cityGuideTitle: "Yabancı Öğrenciler İçin İskenderun Şehir ve Yaşam Rehberi",
    cityGuideSub: "İskenderun'daki öğrenci çalışma kafeleri, önemli bölgeler, AVM'ler, toplu taşıma ve resmi kurum adresleri.",
    allPlaces: "Tüm Mekanlar ve Konumlar",
    catCafes: "Çalışma Kafeleri & Kütüphaneler",
    catDistricts: "Önemli Bölgeler & Sahil Kordonu",
    catShopping: "AVM & Alışveriş Merkezleri",
    catTransport: "Toplu Taşıma & Seyahat İstasyonları",
    catServices: "Resmi Kurumlar & Göç/Nüfus",
    catHospitals: "Hastaneler & Acil Sağlık",
    catFood: "Meşhur İskenderun Döneri & Lezzetler",
    catBazaars: "Haftalık Semt Pazarları",
    operatingDayLabel: "Pazar Günü",
    operatingDayPlaceholder: "Örn: Pazartesi",
    bazaarScheduleTitle: "İskenderun Haftalık Semt Pazarları Günleri ve Yerleri 🛒",
    bazaarScheduleSub: "Taze sebze, meyve, şarküteri ve uygun fiyatlı pazar alışverişi için İskenderun semt pazarları rehberi.",
    bazaarDayPrefix: "Günü:",
    bazaarAddressNote: "Adres ve Pazar Alanı",
    searchCityPlaceholder: "Mekan, kafe, semt, adres veya özellik (Wi-Fi, çalışma vb.) ara...",
    openInGoogleMaps: "Google Haritalar'da Aç",
    copyAddress: "Adresi Kopyala",
    addressCopied: "Adres başarıyla panoya kopyalandı!",
    studentPopular: "Öğrenci Dostu Mekan 🎓",
    studentTipsLabel: "Öğrencilere Tavsiyeler & İpuçları",
    openingHoursLabel: "Çalışma Saatleri",
    districtLabel: "Bölge / Semt",
    noPlacesFound: "Aramanıza uygun mekan bulunamadı.",
    placesCount: "Kayıtlı Mekan",
    quickStudentGuideModalTitle: "İskenderun Yaşam ve Ulaşım Kapsamlı Öğrenci Rehberi",
    readStudentGuide: "Kapsamlı Öğrenci Ulaşım & Yaşam Rehberi 📖",
    sharePlace: "Konumu Paylaş",
    featuresLabel: "Öne Çıkan Özellikler",
    featWifi: "Hızlı Wi-Fi",
    featStudy: "Sessiz Çalışma Alanı",
    featBudget: "Bütçe Dostu Öğrenci Fiyatı",
    featSeaView: "Deniz Manzaralı",
    featOpenLate: "Gece Geç Saate Kadar Açık",
    featBusStop: "Toplu Taşıma Durağı Yakını",
    featCampus: "Kampüs İçi",
    tabCityPlaces: "İskenderun Rehberi Yönetimi",
